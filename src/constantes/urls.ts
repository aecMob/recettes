export class Urls {
    static urlDeBase = 'https://www.themealdb.com/api/json/v1/1/';
    ...
    static listIngreds = 'list.php?i=list';
    static fltrIngred = 'i=';
    static fltrCat = 'c=';
    static fltrReg = 'a=';
    static img = 'www.themealdb.com/images/i';
    static recetteImg = 'meals/';
    static ingredImg = 'ingredients/';
}